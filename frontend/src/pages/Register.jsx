        ...
        <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl p-6">
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="mt-1 h-10 w-full rounded-lg bg-white/5 border border-white/10 px-4 py-2.5 text-white placeholder-gray-500 outline-none focus:border-violet-500"
            />
          </div>
          ...
          <div className="mt-3">
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full h-10 rounded-lg bg-white/5 border border-white/10 px-4 py-2.5 pr-11 text-white placeholder-gray-500 outline-none focus:border-violet-500"
              />
          ...
          <button
            ...
            disabled={loading}
            className="mt-5 w-full rounded-lg bg-gradient-to-r from-violet-600 to-cyan-500 py-2.5 font-semibold flex items-center justify-center gap-2 hover:scale-[1.02] transition disabled:opacity-60"
          >
